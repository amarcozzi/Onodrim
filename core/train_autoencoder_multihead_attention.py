...
from models import AttentionAutoencoder, PyTorchMultiheadAttention
...
def main():
    ...
    MODEL_NAME = 'multihead_attention_autoencoder'
    ...
    model = AttentionAutoencoder(
        ...
        dropout_rate=dropout_rate, attention_module=PyTorchMultiheadAttention
    )
