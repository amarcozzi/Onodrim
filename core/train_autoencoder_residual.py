"""
train_autoencoder_residual.py

Main script to train and evaluate the Residual Autoencoder.
"""
...
def main():
    ...
    model = ResidualAutoencoder(
        input_dim, latent_dim=latent_dim, hidden_dims=hidden_dims, dropout_rate=dropout_rate
    )
